...
export default class PopupTypeReg extends Popup {
  ...
  _bind() {
    ...
    this.closeRegFormByEsc = this.closeByEsc.bind(this);
  ...
  _getHandlers() {
    this._handlers = [
      ...
      { element: document, event: 'keydown', handler: this.closeRegFormByEsc },
    ];
  }
